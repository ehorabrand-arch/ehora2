...
**23 skills are bundled** in `.claude/skills/` and load automatically — no installation needed:
...
| `design-taste-frontend` | Anti-slop frontend skill for landing pages, portfolios, and redesigns. Real design systems, audit-first on redesigns |
...
| `playwright-cli` | Visual QA via browser screenshots and browser automation |
...
**74+ real-world design systems** are available in `design-references/` directory. These include design analyses from:
- **Tech:** Apple, Claude, Meta, Google, Microsoft, Amazon
- **Design/Dev Tools:** Figma, Vercel, Framer, Webflow, Cursor
- **Fintech:** Stripe, Revolut, Coinbase, Kraken
- **Lifestyle & More:** Airbnb, Uber, Spotify, Tesla, Nike, Nintendo, and 50+ others

Each `design-references/{company}/DESIGN.md` contains detailed analysis of:
- Color palettes and contrast strategies
- Typography hierarchies and font selections
- Component patterns and design systems
- Layout principles and spacing strategies
- Motion and interaction patterns

**Use these as reference** when making design decisions during Phase 2. Cross-reference against the chosen archetype to ensure designs are grounded in real-world patterns and best practices.
